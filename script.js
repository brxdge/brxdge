/* =========================================================
   ...
   toggling this URL and remembering to switch it back — running
   `node index.js` locally while this constant still pointed at the
   live Render URL was exactly what made local testing look "slow"
   (it was quietly hitting Render's cold-start, not localhost, the
   whole time). Covers opening this file directly (file://, empty
   hostname) and serving it via a local dev server (localhost/127.0.0.1)
   — anything else (Netlify, a custom domain) falls back to the real
